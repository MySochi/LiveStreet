	...
	<footer id="footer">
		...
		<ul class="footer-list">
			<li class="footer-list-header">{$aLang.topic_title}</li>
			<li><a href="{router page='feed'}">{$aLang.userfeed_title}</a></li>
			<li><a href="{router page='#'}">{$aLang.footer_best}</a></li>			
			<li><a href="{router page='sandbox'}">{$aLang.footer_sandbox}</a></li>
			{hook run='footer_menu_project_item'}
		</ul>

		<ul class="footer-list">
			<li class="footer-list-header">{$aLang.footer_info}</li>
			<li><a href="{router page='about'}">{$aLang.footer_menu_project_about}</a></li>
			<li><a href="{router page='help/rules'}">{$aLang.footer_rules}</a></li>			
			<li><a href="{router page='help'}">{$aLang.footer_menu_project_help}</a></li>			
			<li><a href="{router page='page/info/agreement'}">{$aLang.footer_agreement}</a></li>
			<li><a href="{router page='page/info/stats'}">{$aLang.footer_stat}</a></li>
			{hook run='footer_menu_project_item'}
		</ul>
		...
		*}
		...
		<div class="copyright">
			<ul class="web-ls-social">
				<li><a href="https://plus.google.com/111205186731092940324" target="_blank" rel="publisher">&#232;</a></li>
				<li><a href="http://youtube.com/openrise/" target="_blank" rel="publisher">&#240;</a></li>
				<li><a href="http://steamcommunity.com/groups/openrise" target="_blank" rel="publisher">&#0108;</a></li>
				<li><a href="http://github.com/openrise" target="_blank" rel="publisher">&#0082;</a></li>
			</ul>
			...
			<div class="design-by">{hook run='copyright'}<br>© 2011&#8211;2013
		</div>
