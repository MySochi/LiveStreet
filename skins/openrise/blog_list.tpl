			...
			{foreach from=$aBlogs item=oBlog}
				...
				<tr>
					...
					<td class="cell-avatar">
						<div style="background: url('{$oBlog->getAvatarPath(48)}'); width: 48px; height: 48px; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px; border: 1px solid #10C9D1;"></div>						
					</td>
					<td class="cell-name">
						<p>
